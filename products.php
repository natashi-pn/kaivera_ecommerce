...
<body style="background: #121212" data-page="product">
  ...
  <!-- Product Section -->
  <a href="cart.php" class="help-target remove_cursor" data-help="Go To Cart">
  ...
  <section class="product_details hidden" id="product-popup">
    <div class="product_details_container popup-content">
      <div class="image help-target remove_cursor" id="product_image" data-help="Double Click to Close">
        ...
        <a href="cart.php" class="help-target remove_cursor" data-help="Cart"><i class="fa-solid fa-cart-shopping"></i></a>
      </div>
      <div class="content">
